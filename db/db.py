...
🕗 Время: {time}""", 'Уведомление о новой заявке для администраторов'),
            ...
            ('iron_explanation', 'Вы заказали утюг и гладильную доску. Хотите добавить дополнительные пожелания?', 'Пояснение для заказа утюга'),
            ('laundry_explanation', 'Вы заказали услуги прачечной. Хотите добавить дополнительные пожелания?', 'Пояснение для заказа прачечной'),
            ('ac_explanation', 'Вы сообщили о проблеме с кондиционером. Хотите добавить дополнительные детали?', 'Пояснение для проблемы с кондиционером'),
            ('wifi_explanation', 'Вы сообщили о проблеме с WiFi. Хотите добавить дополнительные детали?', 'Пояснение для проблемы с WiFi'),
            ('tv_explanation', 'Вы сообщили о проблеме с телевизором. Хотите добавить дополнительные детали?', 'Пояснение для проблемы с телевизором'),
            ('tech_other_explanation', 'Вы сообщили о другой технической проблеме. Хотите добавить дополнительные детали?', 'Пояснение для другой технической проблемы'),
            ('restaurant_call_explanation', 'Вы хотите соединиться с рестораном. Хотите добавить дополнительные пожелания?', 'Пояснение для соединения с рестораном'),
...
👤 Пользователь: {user_link} (ID: {user_id}, комната {room})
📝 Сообщение: {message}

🔔 Обращение #{appeal_id}""", 'Уведомление о новом сообщении пользователя'),
